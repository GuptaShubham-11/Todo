            ...
            {isFocusMode && (
                <div className="fixed inset-0 bg-gray-900 text-white flex flex-col items-center justify-center z-50">
                    ...
                    <div className="flex gap-6">
                        <button
                            className="bg-green-500 hover:bg-green-600 text-white font-semibold py-3 px-6 rounded shadow text-lg"
                            onClick={isPaused ? startTimer : pauseTimer}
                        >
                            {isPaused ? "Resume" : "Pause"}
                        </button>
                        <button
                            className="bg-red-500 hover:bg-red-600 text-white font-semibold py-3 px-6 rounded shadow text-lg"
                            onClick={resetTimer}
                        >
                            Reset
                        </button>
                        <button
                            className="bg-gray-700 hover:bg-gray-800 text-white font-semibold py-3 px-6 rounded shadow text-lg"
                            onClick={toggleFocusMode}
                        >
                            Exit Focus (ESC)
                        </button>
